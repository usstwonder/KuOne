...
public class IphoneTouchInterceptor extends ListView {
    ...
    public IphoneTouchInterceptor(Context context, AttributeSet attrs) {
        super(context, attrs);
//        SharedPreferences pref = context.getSharedPreferences("Music", 3);
//        mRemoveMode = pref.getInt("deletemode", -1);
        mTouchSlop = ViewConfiguration.get(context).getScaledTouchSlop();
        Resources res = getResources();
        Drawable itemBackground = res.getDrawable(R.drawable.iphone_weathersettings_rectnoround_white);
        mItemHeightNormal = itemBackground.getIntrinsicHeight();
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        if ((mDragListener != null || mDropListener != null ) && !isDeleteMode) {
            switch (ev.getAction()) {
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        if ((mDragListener != null || mDropListener != null) && mDragView != null && !isDeleteMode) {
...
//        }
    	//2011-5-23 改变透明度
    	mWindowParams.alpha = mDrawingCacheAlpha;
    	mWindowParams.horizontalMargin = mDrawingCacheHorizontalMargin;
	...
	// 设置DrawingCach的 HorizontalMargin
	private float mDrawingCacheHorizontalMargin;
	public void setDrawingCacheHorizontalMargin(float drawingCacheHorizontalMargin) {
		mDrawingCacheHorizontalMargin = drawingCacheHorizontalMargin;
	}
	
	// 设置DrawingCach的透明度
	private int mDrawingCacheAlpha;
	public void setDrawingCacheAlpha(int drawingCacheAlpha) {
		mDrawingCacheAlpha = drawingCacheAlpha;
	}
}